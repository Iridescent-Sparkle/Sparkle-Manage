...
<template>
  <VCard>
    ...
    <VCardText class="d-flex align-center justify-center gap-3">
      ...
      >
        <span class="text-medium-emphasis text-xs">{{ tabData.profitLossAmount }}</span>
      </VProgressCircular>
      ...
      <div>
        ...
        <span class="text-disabled text-sm">{{ tabData.compareToLastWeek }} less than last week</span>
      </div>
    </VCardText>
  </VCard>
</template>
