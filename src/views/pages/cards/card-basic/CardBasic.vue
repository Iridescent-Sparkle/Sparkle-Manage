...
<template>
  <VRow>
    ...
    >
      <VCard>
        <div class="d-flex justify-space-between flex-md-nowrap flex-column flex-md-row flex-wrap">
      ...
      <VCard>
        <div class="d-flex flex-column-reverse flex-md-row">
          <div>
            ...
            <VCardText class="d-flex align-center text-body-1 flex-wrap">
              <VRating
                :model-value="5"
                readonly
                class="me-3"
    ...
    >
      <VCard>
        <VRow no-gutters>
          ...
          >
            <div class="membership-pricing d-flex flex-column align-center h-100 justify-center py-14">
              <p class="mb-5">
